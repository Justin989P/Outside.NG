...
const Footer = () => {
    return (
        <div className='bg-gradient-to-t from-textColor to-purpleColor'  >
            <div className='text-whiteColor pt-[31px] px-[69px] flex justify-between mb-[111px] items-center  '>
                <div>
                    ...
                    <p className='font-[200] text-[16px] w-[120px]'>Party Lovers, and expense managements for your events.</p>
                </div>
